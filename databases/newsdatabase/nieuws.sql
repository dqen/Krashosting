...
--
-- Host: localhost:8889
-- Gegenereerd op: 27 okt 2017 om 10:14
-- Serverversie: 5.6.35
-- PHP-versie: 7.1.6
...
(4, 'Brand new title!', 'This should be an article with at least onehundredandsixtyfive characters. This should not take too long, but It\'s hard to think of a random string of words that don...', 'This should be an article with at least onehundredandsixtyfive characters. This should not take too long, but It\'s hard to think of a random string of words that don\'t really have anything in common. The best would be if this actually surpasses onehundredandsixtyfive characters, so I can test if my class function works all right and fine.');
...
--
ALTER TABLE `nieuwsitems`
  MODIFY `idnieuws` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
